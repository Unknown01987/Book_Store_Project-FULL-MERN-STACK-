...
const BookSingleCard = ({ book }) => {
  ...
  return (
    ...
    >
      <h2 className="absolute top-2 right-2 px-4 py-1 bg-red-300 text-white rounded-lg">
        {book.publishYear}
      </h2>
      ...
      <div className="flex justify-center items-center gap-x-13 mt-4 p-4">
        <BiShow
          className="w-8 h-8 text-blue-800 hover:text-black cursor-pointer"
